...
const stats = [
    { label: 'Total Volume', value: '$125,647', change: '+12.5%', icon: TrendingUp, color: 'text-[#00FF88]', bg: 'bg-[#00FF88]/10' },
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-1 space-y-8">
                    <div>
                        ...
                        <p className="text-gray-500 font-medium">Hello Daniel, your agents are successfully routing wealth across 8 borders.</p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        ...
                        <div className="p-10 pulse-card bg-gradient-to-br from-zinc-900 to-black border-white/10 relative overflow-hidden flex flex-col justify-between min-h-[400px]">
                            <div className="absolute top-0 right-0 w-80 h-80 bg-[#00FF88]/5 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none" />
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="px-3 py-1 bg-[#00FF88]/10 rounded-full text-[10px] font-bold text-[#00FF88] border border-[#00FF88]/10">+1.2k USDC Today</div>
                                </div>
                            </div>
                        ...
                        <div className="p-8 border-b border-white/5 flex items-center justify-between bg-white/[0.01]">
                            <div className="flex items-center gap-4">
                                <div className="relative">
                                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#00FF88] to-blue-500 flex items-center justify-center text-black font-black">AI</div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-[10px] font-bold text-[#00FF88] uppercase tracking-widest">Active</span>
